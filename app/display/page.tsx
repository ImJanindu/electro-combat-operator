  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden scanlines select-none cursor-default">
      ...
      <div className="absolute top-8 left-1/2 -translate-x-1/2 z-50">
        <img src="/logo.png" alt="ElectroCombat Logo" className="h-12 md:h-16 lg:h-20 w-auto opacity-90 drop-shadow-[0_0_15px_rgba(0,255,255,0.3)]" />
      </div>

      {/* ---- IDLE state ---- */}
      {isIdle && (
        <div className="relative z-20 text-center animate-slide-up">
          <p className="font-mono text-sm tracking-[0.4em] text-muted uppercase mb-4">
